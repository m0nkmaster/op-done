...
- Uses `createLlmSound` in `src/audio/llmSound.ts` to translate prompts into expressive synth parameters with stochastic nuance and imagery-driven shaping, then renders WAV bytes client-side.
